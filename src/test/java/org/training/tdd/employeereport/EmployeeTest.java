...
class EmployeeTest {
    ...
    void shouldGetOnlyAdultEmployees(String input) {
        ...
        assertThat(employees).matches(Employees::areAdultEmployees);
    }
    ...
    void shouldGetEmployeesWithNameOrCompoundNameCapitalized(String input) {
        ...
        assertThat(employees).matches(Employees::haveCapitalizedNameOrCompoundName);
    ...
    void shouldGetEmployeesSortedByTheirNameInDescendingOrder() {
        ...
        assertThat(employees).matches(Employees::areSortedByTheirNameInDescendingOrder);
